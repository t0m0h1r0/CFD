...
class CCDSolver:
    ...
    def __init__(self, system, grid):
        ...
        self._solver = create_ccd_solver(system, grid)
    ...
    def set_solver(self, method="direct", options=None, scaling_method=None):
        ...
        """
        self._solver.set_solver(method, options, scaling_method)
    ...
    def solve(self, analyze_before_solve=True):
        ...
        """
        return self._solver.solve(analyze_before_solve)
    ...
    def analyze_system(self):
        ...
        Returns:
            疎性情報の辞書
        """
        return self._solver.analyze_system()